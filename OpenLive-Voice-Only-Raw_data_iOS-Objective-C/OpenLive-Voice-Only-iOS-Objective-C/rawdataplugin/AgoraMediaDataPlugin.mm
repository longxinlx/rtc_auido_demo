...
public:
    ...
    AgoraAudioRawData* getAudioRawDataWithAudioFrame(AudioFrame& audioFrame)
    {
        ...
        NSLog(@"audioFrame.samples: %d, audioFrame.channels: %d , audioFrame.bytesPerSample: %d " , audioFrame.samples,audioFrame.channels,audioFrame.bytesPerSample);
        data.samplesPerChannel = audioFrame.samples;
        ...
        data.bufferLength = audioFrame.samples * audioFrame.channels * audioFrame.bytesPerSample;
        return data;
    }
